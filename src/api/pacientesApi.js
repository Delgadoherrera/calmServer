  ...
  Paciente.update(
    {
      ...
      nombreFamiliar: req.body.nombreFamiliar || null,
      apellidoFamiliar: req.body.apellidoFamiliar || null,
      telefono: req.body.telefono || null,
      email: req.body.email || null,
      patologia: req.body.patologia || null,
      asistente: req.body.asistente || null,
      valores: req.body.valores || null,
      fechaInicio: req.body.fechaInicio | null,
      fechaFinal: req.body.fechaFinal || null,
      notasVarias: req.body.notasVarias || null,
